...
equal(statusSource.includes("line6: \"线路6\""), true);
equal(statusSource.includes('line6: "violet"'), true);
...
equal(styles.includes('.topbar-line-badge[data-line="line6"]'), true);
equal(styles.includes("--line6-violet"), true);
