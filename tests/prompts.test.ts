...
ok(avatarCategoryPrompt.includes("上传的产品图"));

const storefrontPrompt = buildStorefrontPrompt("鲜椒鸡排", "炸货");
ok(storefrontPrompt.includes("店铺经营品类：炸货"));
ok(storefrontPrompt.includes("上传的产品图"));
...
equal(storefrontPrompt.includes("请参考已生成的头像图"), false);
equal(storefrontPrompt.includes("头像图"), false);

const posterPrompt = buildPosterPrompt("鲜椒鸡排", "炸货");
ok(posterPrompt.includes("店铺经营品类：炸货"));
ok(posterPrompt.includes("上传的产品图"));
...
equal(posterPrompt.includes("请参考已生成的头像宣传图"), false);
equal(posterPrompt.includes("头像图"), false);
equal(posterPrompt.includes("店招图"), false);
